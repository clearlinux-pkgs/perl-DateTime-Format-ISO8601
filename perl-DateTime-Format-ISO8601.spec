...
Source0  : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/DateTime-Format-ISO8601-0.14.tar.gz
...
%prep
%setup -q -n DateTime-Format-ISO8601-0.14
cd %{_builddir}/DateTime-Format-ISO8601-0.14
