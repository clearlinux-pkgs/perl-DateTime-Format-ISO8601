...
Version  : 0.15
Release  : 7
URL      : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/DateTime-Format-ISO8601-0.15.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/DateTime-Format-ISO8601-0.15.tar.gz
...
%prep
%setup -q -n DateTime-Format-ISO8601-0.15
cd %{_builddir}/DateTime-Format-ISO8601-0.15
...
cp %{_builddir}/DateTime-Format-ISO8601-0.15/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime-Format-ISO8601/95a011b714b86bd1b5de31bf9a3a7e8095af545f
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-DateTime-Format-ISO8601/95a011b714b86bd1b5de31bf9a3a7e8095af545f
